...
class User: NSObject {
    let avartar_default = "https://firebasestorage.googleapis.com/v0/b/kncenima.appspot.com/o/Images%2Fdefault_avatar.png?alt=media&token=5811b7ed-bb96-4a74-a7c1-93e5c2e3110c"
    ...
    override init(id: String, jSonData: [String: AnyObject]) {
